...
<!-- 價格資料 -->
     ...
     <div class="flex flex-wrap gap-2 mb-4">
      ...
      <button @click="addCard('圓弧造型')" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600">➕ 圓弧造型</button> <a class= "text-blue-600 border rounded-sm m-4" href="https://docs.google.com/spreadsheets/d/1G1SbEPxp8xnAwU2f-EcQfTYNrHhcn2hi2qkfUwSYS6w/edit?gid=0#gid=0" target="_blank">修改圓弧工資</a>
